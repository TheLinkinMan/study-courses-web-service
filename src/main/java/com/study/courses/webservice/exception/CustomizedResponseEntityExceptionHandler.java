package com.study.courses.webservice.exception;
...
public class CustomizedResponseEntityExceptionHandler extends
    ...
    public final ResponseEntity<Object> handleSubjectNotFoundException(TeacherNotFoundException ex, WebRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage(),
                request.getDescription(false));
        return new ResponseEntity(exceptionResponse, HttpStatus.NOT_FOUND);
    }
